...
* [2503] ⭐️ [SWEET-RL: Training Multi-Turn LLM Agents on Collaborative Reasoning Tasks](https://arxiv.org/pdf/2503.15478) (Meta, UC Berkeley) [we want the agents not only complete a task, but also complete the task in the way we want it to be done. propose new ColBench. **Next Step**]
...
* Comment: WebRL and DigiRL can be unstable and highly sensitive to hyperparameters and reward design from PLAN-AND-ACT
...
* Comment: It seems generate data as a strategy
